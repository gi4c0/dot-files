vim.opt.hidden  =  true
vim.opt.keymap = "russian-jcukenwin"          -- Russian language
vim.opt.iminsert = 0
vim.opt.imsearch = 0
vim.opt.showcmd = true               -- Show commands
vim.opt.laststatus = 3          -- influences when the last window will have a status line (2 - always)
...
vim.opt.hlsearch = true              -- Highlighting search result
