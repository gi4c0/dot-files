...
before packages are loaded."
  ;; Copy line till end wity 'Y'
  (unless (boundp 'evil-want-Y-yank-to-eol)
    (evil-add-command-properties 'evil-yank-line :motion 'evil-end-of-line))

  ;; Support for Russian language <C-\> for toggle
